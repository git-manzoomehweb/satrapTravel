                                                ...
                                                ${item.hotel.label}
                                                    ...
                                                    <figure class="h-[206px] w-[296px] max-md:!w-full rounded-2xl overflow-hidden ${
                                                      index === 0
                                                        ...
                                                        <img src="${img}" class="rounded-2xl w-full h-full object-cover tourInventory__details__item__img transition-all hover:scale-105" data-pageName="${
          document.querySelector(".layout__body__container").dataset
            .pagenameinventory
        }" data-id="${item.hotel.hotelname1.hotelid}" width="296"
                                                            height="206" alt="" />
                                                    </figure>
                                                    <figcaption>
                                                        <div class="flex flex-col gap-3">
                                                            <div class="flex flex-col gap-3">
                                                                ...
                                                                <div class="tourInventory__details__item__service flex gap-2 text-sm max-lg:mb-2" data-value="${
                                                                  item.hotel
                                                                    .service.vid
                                                                }">
                                                            ...
                                                            <div class="tourInventory__details__item__rate flex gap-2" data-value="${
                                                              item.hotel.star ==
                                                              ""
                                                                ? 0
                                                                : item.hotel
                                                    ...
                                                    <div class="flex gap-4 flex-col">
                                                        ...
                                                        <button type="button" onclick="renderTourForm(this)"
                                                            ...
                                                            <span
                                                                ...
                                                                <svg class="group-hover:scale-125" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4.46967 12.5303C4.17678 12.2374 4.17678 11.7626 4.46967 11.4697L10.4697 5.4697C10.7626 5.1768 11.2374 5.1768 11.5303 5.4697C11.8232 5.7626 11.8232 6.2374 11.5303 6.5303L6.81066 11.25L19 11.25C19.4142 11.25 19.75 11.5858 19.75 12C19.75 12.4142 19.4142 12.75 19 12.75L6.81066 12.75L11.5303 17.4697C11.8232 17.7626 11.8232 18.2374 11.5303 18.5303C11.2374 18.8232 10.7626 18.8232 10.4697 18.5303L4.46967 12.5303Z" fill="#171717" class="group-hover:fill-secondary-700"></path>
                                                </svg>
                                                                </button>
                                                    </div>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M19.8537 12.8387C19.6562 12.2876 19.2306 11.8593 18.6796 11.6627C18.3639 11.5547 18.0353 11.5547 17.3799 11.5547H5.018C4.36353 11.5547 4.034 11.5547 3.71276 11.6655C3.16907 11.8584 2.74261 12.2858 2.54415 12.8368C2.42969 13.1535 2.42969 13.483 2.42969 14.1393V15.4233C2.42969 16.0851 2.42969 16.4175 2.54415 16.7341C2.74076 17.2796 3.16723 17.7042 3.70261 17.8935C3.86692 17.9553 4.034 17.9867 4.24353 18.0015V18.9947C4.24353 19.3768 4.55369 19.687 4.93584 19.687C5.318 19.687 5.62815 19.3768 5.62815 18.9947V18.0162H16.7706V18.9947C16.7706 19.3768 17.0808 19.687 17.4629 19.687C17.8451 19.687 18.1553 19.3768 18.1553 18.9947V18.0015C18.3629 17.9867 18.5273 17.9571 18.6851 17.8962C19.2325 17.7033 19.658 17.2787 19.8528 16.735C19.9682 16.4175 19.9682 16.0851 19.9682 15.4233V14.1393C19.9682 13.4821 19.9682 13.1535 19.8537 12.8387Z" fill="#D4D4D8"/>
        ...
        case 1655:
          ...
          img = `<svg  class="shrink-0" width="19" height="19" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.85145 3.1977C8.12544 2.92371 8.12544 2.47949 7.85145 2.20549C7.57746 1.9315 7.13323 1.9315 6.85925 2.20549C6.05734 3.00739 6.05734 4.30619 6.85925 5.10809C7.11226 5.36062 7.11343 5.77208 6.85925 6.02626C6.58525 6.30025 6.58525 6.74448 6.85925 7.01847C7.13323 7.29246 7.57746 7.29246 7.85145 7.01847C8.65293 6.21699 8.65377 4.91717 7.85145 4.11588C7.59777 3.86194 7.59761 3.45154 7.85145 3.1977Z" fill="#D4D4D8"/>
...
<path d="M4.43209 6.0258C4.15809 5.75181 3.71387 5.75181 3.43987 6.0258C3.16588 6.2998 3.16588 6.74402 3.43987 7.01801C3.69379 7.27193 3.69379 7.68227 3.43987 7.93619C3.16588 8.21018 3.16588 8.65442 3.43987 8.92841C3.71387 9.2024 4.15809 9.2024 4.43209 8.92841C5.23399 8.12651 5.23399 6.82771 4.43209 6.0258Z" fill="#D4D4D8"/>
        ...
        case 1656:
          ...
          img = `<svg  class="shrink-0" width="19" height="19" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.15667 3.03914C6.17828 2.48728 5.74844 2.02239 5.19658 2.00078C4.64472 1.97917 4.17983 2.40903 4.15822 2.96089L3.95389 8.17889C3.95338 8.19192 3.95312 8.20497 3.95312 8.21801C3.95312 10.2194 5.33799 11.8969 7.20095 12.3464L7.20171 21.0001C7.20177 21.5524 7.64953 22.0001 8.20181 22C8.7541 22 9.20176 21.5522 9.20171 20.9999L9.20096 12.3465C11.0644 11.8969 12.4486 10.2193 12.4486 8.21801C12.4486 8.20503 12.4483 8.19205 12.4478 8.17907L12.2445 2.96107C12.223 2.40921 11.7582 1.97927 11.2063 2.00077C10.6544 2.02228 10.2245 2.48709 10.246 3.03896L10.4485 8.23573C10.439 9.46827 9.43701 10.4648 8.20088 10.4648C6.96555 10.4648 5.96276 9.46812 5.9532 8.23582L6.15667 3.03914Z" fill="#D4D4D8"/>
<path d="M9.20312 3C9.20312 2.44772 8.75541 2 8.20312 2C7.65084 2 7.20312 2.44772 7.20312 3V7.78893C7.20312 8.34121 7.65084 8.78893 8.20312 8.78893C8.75541 8.78893 9.20312 8.34121 9.20312 7.78893V3Z" fill="#D4D4D8"/>
...
<path d="M2.80133 18.0844C3.00334 17.9222 3.25079 17.8594 3.50324 17.8594H20.5032C20.7557 17.8594 21.0031 17.9222 21.2052 18.0844C21.4075 18.2468 21.5092 18.4647 21.5535 18.6706C21.6361 19.0548 21.5406 19.4911 21.4256 19.8366C21.1035 20.8027 20.1981 21.4553 19.1794 21.4553H4.82711C3.80834 21.4553 2.90303 20.803 2.58099 19.8368C2.46599 19.4913 2.37035 19.0548 2.45296 18.6706C2.49723 18.4647 2.599 18.2468 2.80133 18.0844Z" fill="#D4D4D8"/>
      ...
      return `${img}<span class="text-sm text-[#262626]">${sevice}</span><span class="text-sm font-medium text-[#262626]">${title}</span>`;
    }
  } catch (err) {
...
const renderTourForm = async (element) => {
  switch (
    parseInt(
      element
        .closest(".tourInventory__details__item__info")
...
const onrenderedSchmaTourBookingFormIns = async (args) => {
  try {
    document.querySelector(".first-last-name input").placeholder =
      "نام و نام خانوادگی";
    ...
    (document
      ...
      .querySelector(".adult-count")
      .querySelector("input").value = adultCountF),
      (document
        .querySelector(".tour__booking__form__modal__container_Ins")
        .querySelector(".child-count")
        .querySelector("input").value = childbedCountF),
      (document
        .querySelector(".tour__booking__form__modal__container_Ins")
        .querySelector(".infant-count")
        .querySelector("input").value = infantCountF + childwobedCountF);
    ...
    document
      .querySelector(".tour__booking__form__modal__container_Ins")
      .querySelector(".total-amountF")
      .querySelector("input").value = document
      .querySelector("#white-modal")
      .querySelector(".total-amount").innerText;
    document
      .querySelector(".tour__booking__form__modal__container_Ins")
      .querySelector(".total-advanceF")
      .querySelector("input").value = document
      .querySelector("#white-modal")
      .querySelector(".Total-amount-facilities").innerText;
    document
      .querySelector(".tour__booking__form__modal__container_Ins")
      .querySelector(".amount-facilitiesF")
      .querySelector("input").value = document
      .querySelector("#white-modal")
      .querySelector(".Total-advance-payment").innerText;
    document
      .querySelector(".tour__booking__form__modal__container_Ins")
      .querySelector(".amount-eachF")
      .querySelector("input").value = document
      .querySelector("#white-modal")
    ...
    console.error(
      "onrenderedSchmatourBookingFormIns=" + err.lineNumber + "," + err.message
    );
  }
};
